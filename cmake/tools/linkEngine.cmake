function(LinkEngine target_name)
    add_dependencies(${target_name} FantasyEngine::Engine)
    target_link_libraries(${target_name} PUBLIC FantasyEngine::Engine)

    set(DEPLOY_TARGET_NAME "${target_name}LinkREngine")

    add_custom_target(${DEPLOY_TARGET_NAME}
        COMMAND ${CMAKE_COMMAND} -E copy_directory
            "$<TARGET_FILE_DIR:FantasyEngine::Engine>" "$<TARGET_FILE_DIR:${target_name}>"
        COMMENT "Deploying FantasyEngine::Engine binaries to $<TARGET_FILE_DIR:${target_name}>"
        VERBATIM
    )

    add_dependencies(${target_name} ${DEPLOY_TARGET_NAME})
    add_dependencies(${DEPLOY_TARGET_NAME} FantasyEngine::Engine)
