...
class CommandQueue {
 ...
 public:
  ...
  FE_FINLINE bool IsReady() { return m_CommandQueue != nullptr; }
...
class CommandListManager {
 ...
 public:
  ...
  bool IsFenceComplete(uint64_t FenceValue) { return GetQueue(D3D12_COMMAND_LIST_TYPE(FenceValue >> 56)).IsFenceComplete(FenceValue); }
