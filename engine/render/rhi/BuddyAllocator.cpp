...
BuddyBlock::BuddyBlock(uint32_t heapOffset, uint32_t totalSize, uint32_t unpaddedSize)
    : m_pBuffer(nullptr), m_pBackingHeap(nullptr), m_offset(heapOffset), m_fenceValue(0), m_size(totalSize), m_unpaddedSize(unpaddedSize) {};
...
BuddyAllocator::BuddyAllocator(kBuddyAllocationStrategy allocationStrategy, D3D12_HEAP_TYPE heapType, size_t maxBlockSize, size_t MinBlockSize,
                               size_t baseOffset)
