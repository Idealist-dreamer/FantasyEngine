...
void GameInput::Update(float frameDelta) {
  ...
  if (ERROR_SUCCESS == XInputGetState(0, &newInputState)) {
    if (newInputState.Gamepad.wButtons & (1 << 0))
      s_Buttons[0][kDPadUp] = true;
    if (newInputState.Gamepad.wButtons & (1 << 1))
      s_Buttons[0][kDPadDown] = true;
    if (newInputState.Gamepad.wButtons & (1 << 2))
      s_Buttons[0][kDPadLeft] = true;
    if (newInputState.Gamepad.wButtons & (1 << 3))
      s_Buttons[0][kDPadRight] = true;
    if (newInputState.Gamepad.wButtons & (1 << 4))
      s_Buttons[0][kStartButton] = true;
    if (newInputState.Gamepad.wButtons & (1 << 5))
      s_Buttons[0][kBackButton] = true;
    if (newInputState.Gamepad.wButtons & (1 << 6))
      s_Buttons[0][kLThumbClick] = true;
    if (newInputState.Gamepad.wButtons & (1 << 7))
      s_Buttons[0][kRThumbClick] = true;
    if (newInputState.Gamepad.wButtons & (1 << 8))
      s_Buttons[0][kLShoulder] = true;
    if (newInputState.Gamepad.wButtons & (1 << 9))
      s_Buttons[0][kRShoulder] = true;
    if (newInputState.Gamepad.wButtons & (1 << 12))
      s_Buttons[0][kAButton] = true;
    if (newInputState.Gamepad.wButtons & (1 << 13))
      s_Buttons[0][kBButton] = true;
    if (newInputState.Gamepad.wButtons & (1 << 14))
      s_Buttons[0][kXButton] = true;
    if (newInputState.Gamepad.wButtons & (1 << 15))
      s_Buttons[0][kYButton] = true;
  ...
  if (gamepads->Size != 0) {
    ...
    if (Buttons & (uint32_t)GamepadButtons::DPadUp)
      s_Buttons[0][kDPadUp] = true;
    if (Buttons & (uint32_t)GamepadButtons::DPadDown)
      s_Buttons[0][kDPadDown] = true;
    if (Buttons & (uint32_t)GamepadButtons::DPadLeft)
      s_Buttons[0][kDPadLeft] = true;
    if (Buttons & (uint32_t)GamepadButtons::DPadRight)
      s_Buttons[0][kDPadRight] = true;
    if (Buttons & (uint32_t)GamepadButtons::Menu)
      s_Buttons[0][kStartButton] = true;
    if (Buttons & (uint32_t)GamepadButtons::View)
      s_Buttons[0][kBackButton] = true;
    if (Buttons & (uint32_t)GamepadButtons::LeftThumbstick)
      s_Buttons[0][kLThumbClick] = true;
    if (Buttons & (uint32_t)GamepadButtons::RightThumbstick)
      s_Buttons[0][kRThumbClick] = true;
    if (Buttons & (uint32_t)GamepadButtons::LeftShoulder)
      s_Buttons[0][kLShoulder] = true;
    if (Buttons & (uint32_t)GamepadButtons::RightShoulder)
      s_Buttons[0][kRShoulder] = true;
    if (Buttons & (uint32_t)GamepadButtons::A)
      s_Buttons[0][kAButton] = true;
    if (Buttons & (uint32_t)GamepadButtons::B)
      s_Buttons[0][kBButton] = true;
    if (Buttons & (uint32_t)GamepadButtons::X)
      s_Buttons[0][kXButton] = true;
    if (Buttons & (uint32_t)GamepadButtons::Y)
      s_Buttons[0][kYButton] = true;
