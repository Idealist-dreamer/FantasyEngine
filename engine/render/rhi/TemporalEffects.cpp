...
void TemporalEffects::Update(uint64_t FrameIndex) {
  ...
  {
    static const float Halton23[8][2] = {{0.0f / 8.0f, 0.0f / 9.0f}, {4.0f / 8.0f, 3.0f / 9.0f}, {2.0f / 8.0f, 6.0f / 9.0f},
                                         {6.0f / 8.0f, 1.0f / 9.0f}, {1.0f / 8.0f, 4.0f / 9.0f}, {5.0f / 8.0f, 7.0f / 9.0f},
...
void TemporalEffects::ApplyTemporalAA(ComputeContext& Context) {
  ...
  ConstantBuffer cbv = {1.0f / g_SceneColorBuffer.GetWidth(),
                        1.0f / g_SceneColorBuffer.GetHeight(),
                        (float)TemporalMaxLerp,
                        1.0f / TemporalSpeedLimit,
                        s_JitterDeltaX,
                        s_JitterDeltaY};
