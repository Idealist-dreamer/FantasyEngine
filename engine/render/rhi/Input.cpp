...
// FE_FINLINE float FilterAnalogInput(int val, int deadZone) {
//   if (val < 0) {
//     if (val > -deadZone)
//       return 0.0f;
//     else
...
// #define SET_BUTTON_VALUE(InputEnum, GameInputMask) s_Buttons[0][InputEnum] = !!(newInputState.Gamepad.wButtons & GameInputMask);
...
// #define SET_BUTTON_VALUE(InputEnum, GameInputMask) s_Buttons[0][InputEnum] = !!(newInputState.buttons & GameInputMask);
