...
GraphicsPSO s_TextPSO[2] = {{L"Text Render: Text R8G8B8A8_UNORM PSO"},
                            {L"Text Render: Text R11G11B10_FLOAT PSO"}};  // 0: R8G8B8A8_UNORM   1: R11G11B10_FLOAT
GraphicsPSO s_ShadowPSO[2] = {{L"Text Render: Shadow R8G8B8A8_UNORM PSO"},
                              {L"Text Render: Shadow R11G11B10_FLOAT PSO"}};  // 0: R8G8B8A8_UNORM   1: R11G11B10_FLOAT
...
void TextRenderer::Initialize(void) {
  ...
  D3D12_INPUT_ELEMENT_DESC vertElem[] = {{"POSITION", 0, DXGI_FORMAT_R32G32_FLOAT, 0, 0, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, 1},
