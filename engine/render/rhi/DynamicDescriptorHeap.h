...
class DynamicDescriptorHeap {
 public:
  ...
  FE_FINLINE void CommitGraphicsRootDescriptorTables(ID3D12GraphicsCommandList* CmdList) {
  ...
  FE_FINLINE void CommitComputeRootDescriptorTables(ID3D12GraphicsCommandList* CmdList) {
 ...
 private:
  ...
  struct DescriptorHandleCache {
    ...
    void CopyAndBindStaleTables(D3D12_DESCRIPTOR_HEAP_TYPE Type, uint32_t DescriptorSize, DescriptorHandle DestHandleStart,
