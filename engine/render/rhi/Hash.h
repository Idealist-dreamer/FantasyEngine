...
namespace Utility {
FE_FINLINE size_t HashRange(const uint32_t* const Begin, const uint32_t* const End, size_t Hash) {
#if ENABLE_SSE_CRC32
...
template <typename T>
FE_FINLINE size_t HashState(const T* StateDesc, size_t Count = 1, size_t Hash = 2166136261U) {
