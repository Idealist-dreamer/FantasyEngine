...
class SystemTime {
 public:
  ...
  static FE_FINLINE double TicksToSeconds(int64_t TickCount) { return TickCount * sm_CpuTickDelta; }

  static FE_FINLINE double TicksToMillisecs(int64_t TickCount) { return TickCount * sm_CpuTickDelta * 1000.0; }

  static FE_FINLINE double TimeBetweenTicks(int64_t tick1, int64_t tick2) { return TicksToSeconds(tick2 - tick1); }
...
class CpuTimer {
 public:
  ...
  double GetTime() const { return SystemTime::TicksToSeconds(m_ElapsedTicks); }
