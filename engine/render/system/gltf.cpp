...
// #include "render/shared/renderGltfCore.h"
// #include "render/shared/gltfComponents.h"
...
// bool RenderGLTF::init(SceneVisitor& visitor) {
//   // 通过 SceneVisitor 获取 WindowContext 初始化相机
...
//   d()->camera.SetEyeAtUp(Vector3(0.0f, 2.0f, -5.0f),  // Eye position
...
//       "RenderGLTF_Draw",
//       [this](ContextWriter<GraphicsCore> gcReader, ComponentReader<GltfModelComponent> modelReader, ContextWriter<WindowContext> windowReader) {
//         if (!gcReader.valid()) {
...
//           if (modelComp.modelId == 0xFFFFFFFF)
//             continue;
