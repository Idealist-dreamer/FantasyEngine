...
// RenderCore::RenderCore() : System("RenderCore"),
// m_pImpl(stl::make_unique<Impl>()) {} RenderCore::~RenderCore() {}
...
//   //   gcInitInfo.enableGPUBasedValidation = false;  // Disable for
//   performance gcInitInfo.enableDXGIDebugInfo = true;
